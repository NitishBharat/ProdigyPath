...
<meta property="og:image" content="https://postimg.cc/R3rW8dkX" />
                        ...
                        <div class="swiper-slide">
                            <div data-swiper-parallax="-100">
                                <div class="section-parallax slide-img"
                                    style="background-image: url(https://th.bing.com/th/id/R.68e9e5b95c3e9d136f31a69bad4b0909?rik=5OmfaAETUjor1w&riu=http%3a%2f%2fwallpapercave.com%2fwp%2fwlfiflX.png&ehk=pW0u%2fjS4ZgQ2%2bqGFlXZoyQ4eEpaBm%2bXQqtgbvXQSP0A%3d&risl=&pid=ImgRaw&r=0);">
                                </div>
                            </div>
                                    ...
                                    <div data-swiper-parallax="-300">
                                        <div class="slideshow">
                                            ...
                                            <p class="slide-text mt-3 mb-4 text-white animated di-1-5 me-3"
                                                data-animation="fadeInUp">We provide innovative,solution to Everything you need to crack your
Next Tech Interview from finding right internship to guidance to resources with excellent peer proggraming and mock interview </p>
                                            <div class="w-100"></div>
                                            <a href="services.php"
                        ...
                        <div class="swiper-slide">
                            <div data-swiper-parallax="-100">
                                <div class="section-parallax slide-img"
                                    style="background-image: url(https://wallpapercave.com/wp/wp8046576.jpg);">
                                </div>
                            </div>
                            <div class="section-mask"></div>
                            <div class="section-content text-center">
                                    ...
                                    <div data-swiper-parallax="-300">
                                        <div class="slideshow">
                                            ...
                                            <span class="slide-text text-yellow animated di-1 me-md-3 me-2"
                                                data-animation="fadeInDown">and innovative</span>
                                            <span class="slide-text text-white animated di-1"
                                                data-animation="fadeInUp">way to learn and grow</span>
                                            <p class="slide-text mt-3 mb-4 text-white animated di-1-5 me-3"
                                                data-animation="fadeInUp">new</p>
                                            <div class="w-100"></div>
                        ...
                        <div class="swiper-slide">
                            <div data-swiper-parallax="-100">
                                <div class="section-parallax slide-img"
                                    style="background-image: url(https://c4.wallpaperflare.com/wallpaper/283/907/801/digital-art-lightbulb-broken-glass-wallpaper-preview.jpg);">
                                </div>
                            </div>
                            <div class="section-mask"></div>
                            <div class="section-content text-center">
                                <div class="container">
                                    <div data-swiper-parallax="-300">
                                        <div class="slideshow">
                                            ...
                                            <p class="slide-text mt-3 mb-4 text-white animated di-1-5 me-3"
                                                data-animation="fadeInUp">Providing simple </p>
                                            <div class="w-100"></div>
                                            <a href="get-quote.php"
                ...
                <div class="row">
                    <div class="col-lg-4 p-md-0">
                        <div class="p-5 section-yellow">
                            <h4>Peer Proggraming</h4>
                            <p class="pt-4">peer programming can be a valuable tool for college students preparing for internships, as it allows them to work together, share knowledge and skills, and learn from one another, which can help them to develop the skills and experience needed to secure an internship and be successful in their career</p>
                        </div>
                    </div>
                    <div class="col-lg-4 p-md-0">
                        <div class="p-5 section-light">
                            <h4>Mock interviews</h4>
                            <p class="pt-4 text-text">The mock interview feature on the ProdigyPath website would provide college students with a valuable tool to prepare for internship interviews, allowing them to practice and improve their interviewing skills, receive feedback and guidance, and build confidence in their abilities. This can ultimately help them in securing an internship.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 p-md-0">
                        <div class="p-5 section-blue">
                            <h4>ROADMAP,UPCOMING HACKATHONS,OFFCAMPUS INTERNSHIP OPENING,RESUME TEMPLATE,DISCUSSION FORUM,MENTORSHIP AND GUIDANCE FROM SENIOR,LEARNING TUTORIAL...</h4>
                            <p class="pt-4">Read More..</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="section-content-v ps-lg-5 ps-0">
                            ...
                            <p class="text-text"> Providing sample code snippets and projects, offering tips and tricks for acing technical interviews and coding challenges,
                                curating a collection of resources such as books, tutorials, and online courses,keeping students informed about upcoming events and deadlines, such as internship application deadlines, coding competitions, and meetups, providing job listings for internships,helping students connect with alumni and mentors.
                            </p>
                        </div>
                    </div>
            ...
            <div class="section-content-v">
                <div class="container">
                    <div class="row justify-content-end">
                        <div class="col-lg-6">
                            <div class="p-5 section-light">
                                <h4 class="font-size-3">Your <span class="Internship"> internship</span> Your way!</h4>
                                <p class="text-text py-4">An internship roadmap on this website would include timeline,checklists,resources,mentorship program,
                                                         success stories, study materials,FAQs.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-lg-0 mb-5">
                        <div class="section-content-v">
                            ...
                            <p class="text-text pe-lg-5 pe-0"> ProdigyPath is a website designed to help college students at IIIT Allahabad navigate the internship application process and make the most of their internship experience
                                                               Our goal is to provide students with the resources and support they need to succeed
                                </p>
                        </div>
                    </div>
                        ...
                        <div class="section-content-v">
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped bg-yellow progress-bar-animated"
                                    ...
                                    data-max="90"></div>
                                <div class="progress_title">Consistency</div>
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped bg-blue progress-bar-animated"
                                    ...
                                    data-max="93"></div>
                                <div class="progress_title">Smartwork</div>
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped bg-dark progress-bar-animated"
                                    ...
                                    data-max="85"></div>
                                <div class="progress_title">Dedication</div>
                                <div class="progress_parcent" data-max="89">%</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="swiper-container homeswiper-02">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="https://avatars.githubusercontent.com/u/7151918?s=200&v=4"
                                ...
                                <div class="swiper-slide">
                                    <img src="https://i.pinimg.com/736x/b4/6e/54/b46e546a3ee4d410f961e81d4a8cae0f.jpg"
